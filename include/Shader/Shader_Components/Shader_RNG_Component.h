...
namespace LR
{
    ...
    class Shader_RNG_Component_Stub : public LR::Shader_Component_Stub
    {
    public:
        INIT_VARIABLE(LR::Shader_RNG_Component_Stub, LR::Shader_Component_Stub)
    ...
    public:
        std::string random_number_uniform_name;
