...
namespace LR
{
    ...
    class Uniform_Setter__Int : public Uniform_Setter
    {
    public:
    ...
    class Uniform_Setter_Stub__Int : public Uniform_Setter_Stub
    {
    public:
        INIT_VARIABLE(LR::Uniform_Setter_Stub__Int, LR::Uniform_Setter_Stub)
