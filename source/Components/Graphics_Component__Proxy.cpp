...
void Graphics_Component__Proxy::link_module_manually(const LR::Draw_Module* _module)
{
    m_linked_graphics_component = _module->get_graphics_component_with_buffer_index(m_linked_buffer_index);
...
void Graphics_Component__Proxy::update(float /*_dt*/)
{
    ...
    link_module_manually(linked_module);
}
