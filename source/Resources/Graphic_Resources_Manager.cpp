...
void Graphic_Resources_Manager::add_resource(const std::string& _name, LV::Variable_Base* _resource, bool _rewrite)
{
    L_ASSERT(_resource);
...
void Graphic_Resources_Manager::remove_resource(const std::string& _name)
{
    Resources_Map::Iterator maybe_loaded_resource_it = m_resources.find(_name);
...
Graphic_Resources_Manager_Stub::~Graphic_Resources_Manager_Stub()
{
...
BUILDER_STUB_CONSTRUCTION_FUNC(Graphic_Resources_Manager_Stub) BUILDER_STUB_CONSTRUCTION_FUNC_DEFAULT_IMPL

BUILDER_STUB_INITIALIZATION_FUNC(Graphic_Resources_Manager_Stub)
{
