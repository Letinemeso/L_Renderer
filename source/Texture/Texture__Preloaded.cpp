...
Texture__Preloaded::Settings::Settings()
{
...
Texture__Preloaded::Texture__Preloaded()
{
...
void Texture__Preloaded::set_settings(const Settings& _settings)
{
...
void Texture__Preloaded::set_bind_index(unsigned int _index)
{
    L_DEBUG_FUNC_NOARG([&]()
                       {
...
void Texture_Stub__Preloaded::apply_settings(Texture__Preloaded* _product) const
{
    Texture__Preloaded::Settings result;
