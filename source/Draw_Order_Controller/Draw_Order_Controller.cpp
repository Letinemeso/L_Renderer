...
Draw_Order_Controller::Registered_Modules& Draw_Order_Controller::M_get_modules_set_for_layer(const std::string& _layer_name)
{
...
void Draw_Order_Controller::register_module(const std::string& _layer_name, LEti::Module* _module, const Draw_Function& _draw_function)
{
    ...
    Registered_Modules& modules_in_layer = M_get_modules_set_for_layer(_layer_name);
